...
export default function Rooms(): ReactElement {
  return (
    <div>
      ...
      <CardGrid>
        <RoomCard id="room-567343525" privacy="private" route="/rooms/room-567343525" membersCount={4352} created="7th November 2021" />
        <RoomCard id="room-567343525" privacy="private" route="/rooms/room-567343525" membersCount={4352} created="7th November 2021" />
        <RoomCard id="room-567343525" privacy="public" route="/rooms/room-567343525" membersCount={4352} created="7th November 2021" />
        <RoomCard id="room-567343525" privacy="private" route="/rooms/room-567343525" membersCount={4352} created="7th November 2021" />
        <RoomCard id="room-567343525" privacy="public" route="/rooms/room-567343525" membersCount={4352} created="7th November 2021" />
        <RoomCard id="room-567343525" privacy="private" route="/rooms/room-567343525" membersCount={4352} created="7th November 2021" />
      </CardGrid>
